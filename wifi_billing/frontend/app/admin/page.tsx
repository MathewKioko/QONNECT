              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">Manage user loans and penalties</p>
                  </div>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Loan Management</h3>
                      <p className="text-slate-600 dark:text-slate-400 mb-4">
                        Click the button above to access detailed loan management features
                      </p>
                      <p className="text-sm text-slate-500 dark:text-slate-500">
                        View all loans, update penalties, and manage loan defaults
                      </p>
                    </div>
                  </CardContent>
                </Card>
