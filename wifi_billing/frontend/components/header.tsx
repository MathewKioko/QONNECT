...
import { Wifi, Menu, X, User, LogOut, Settings } from "lucide-react"
            ...
            {isUser ? (
              <div className="flex items-center space-x-4">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="text-slate-600 dark:text-slate-300 border-slate-300 dark:border-white/10"
                >
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-slate-200/20 dark:border-white/10 py-4">
            <nav className="flex flex-col space-y-4">
              ...
              {isUser ? (
                <div className="space-y-3 pt-2 border-t border-slate-200/20 dark:border-white/10">
                  <div className="flex items-center space-x-2 text-sm text-slate-600 dark:text-slate-300">
                    <User className="w-4 h-4" />
                    <span>{userData?.name || 'User'}</span>
                  </div>
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="w-full text-slate-600 dark:text-slate-300 border-slate-300 dark:border-white/10"
                  >
                    <LogOut className="w-4 h-4 mr-1" />
                    Logout
                  </Button>
